...
import daniel.desafioBoardTarefas.dto.BoardColumnInfoDTO;
import daniel.desafioBoardTarefas.exception.CardBlockedException;
import daniel.desafioBoardTarefas.exception.CardFinishedException;
import daniel.desafioBoardTarefas.exception.EntityNotFoundException;
import daniel.desafioBoardTarefas.persistence.dao.BlockDAO;
import daniel.desafioBoardTarefas.persistence.dao.CardDAO;
import daniel.desafioBoardTarefas.persistence.entity.CardEntity;
...
import static daniel.desafioBoardTarefas.persistence.entity.BoardColumnKindEnum.FINAL;
...
public class CardService {
    ...
    public void moveToNextColumn(final Long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException{
        try{
            ...
            if (FINAL.equals(currentColumn.kind())){
    ...
    public void block(final Long id, final String reason, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException {
        try{
            ...
            var currentColumn = boardColumnsInfo.stream()
                    ...
                    .findFirst()
                    .orElseThrow();
            if (FINAL.equals(currentColumn.kind()) || CANCEL.equals(currentColumn.kind())){
